<html>
<head>
<style>input{border:solid 2px;padding:5px;font-size:28px;}</style></head>
<body>
...
$bill=$temp+($remaining_units * $unit_cost_third);
		...
		$remaing_units=$unit-250;
		$bill=$temp+($remaing_units*$unit_cost_fourth);
		}
